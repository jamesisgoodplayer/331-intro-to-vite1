...
import type { Organizer, OrganizerItem } from '@/types' 
...
<template> 
  <div> 
    ...
    <form @submit.prevent="saveOrganizer">
      <label>ID</label> 
      <input v-model="organizer.id" type="text" placeholder="Category" 
   class="field" /> 
      <h3>Name & describe your organizer</h3> 
      <label>NAME</label> 
      <input v-model="organizer.name" type="text" placeholder="Title" class="field" /> 
      <label>ADDRESS</label> 
      <input v-model="organizer.address" type="text" placeholder="Description" 
  class="field" /> 
